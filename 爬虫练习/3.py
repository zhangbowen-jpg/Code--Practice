...
class CodeSpider:
    ...
    def __init__(self, lesson_name = "C语言", url = "https://www.jisuanke.com/course/786"):
        print('__init__')
        ...
        with open(self.cookie_file, "r") as f:
            for line in f:
                ...
                cookie = {"value": value, "domain": domain, "name": name, "pah": path}
...
#shaohou = get_xpath('//*[@id="finish-footer"]/div[2]/a[1]')
#shaohou.click()

#time.sleep(2)

#lishi = get_xpath('//*[@id="submit-history-trigger"]')
#lishi.click()

#time.sleep(2)

#daima = get_xpath('//*[@id="submit-history"]/div/div[2]/table/tbody/tr/td[5]/a')
#daima.click()

#url = 'https://nanti.jisuanke.com/mycode/pb3xave4nypr0e27/main.py'
#spider(url)
